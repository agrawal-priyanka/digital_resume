...
with col2:
    ...
    with col3:
        ...
        st.markdown(f'<style>.streamlit-button{{background-color: #f63366; color: white; padding: 0.375rem 0.75rem; border: none; border-radius: 0.25rem; cursor: pointer;}}</style>', unsafe_allow_html=True)
