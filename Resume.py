...
with col2:
    ...
    with col3:
        ...
        st.markdown(f'<style>.streamlit-button{{background-color: #e0e0e0; color:#385653; width:104 ;border:1px solid #FF5722;font-weight:300 }}</style>', unsafe_allow_html=True)
